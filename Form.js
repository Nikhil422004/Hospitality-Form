...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    const confirmationEmailInput = document.createElement("input");
    confirmationEmailInput.type = "hidden";
    confirmationEmailInput.name = "ConfirmationEmail";
    confirmationEmailInput.value =
      document.getElementById("confirmationEmail").value;
    form.appendChild(confirmationEmailInput);
